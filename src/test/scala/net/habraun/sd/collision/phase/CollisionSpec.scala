...
object CollisionSpec extends Specification {
	...
	"Collision" should {
		...
		"throw an exception if t is bigger than 1.0." in {
			val t = 1.1
			val contact = Contact( new Shape {}, new Shape {}, Vec2D( 5, 5 ), Vec2D( 1, 0 ), 1, t )
		...
		"throw an exception if contact1 is null." in {
			val t = 0.5
			Collision( t, null, Contact( new Shape {}, new Shape {}, Vec2D( 5, 5 ), Vec2D( 1, 0 ), 1, t ) ) must
					throwA[NullPointerException]
		}

		"throw an exception if contact2 is null." in {
			val t = 0.5
			Collision( t, Contact( new Shape {}, new Shape {}, Vec2D( 5, 5 ), Vec2D( 1, 0 ), 1, t ), null ) must
					throwA[NullPointerException]
		}
		...
		"throw an exception is contact1.s is not equal to contact2.other." in {
			...
			val s1 = new Shape {}
			val s2 = new Shape {}
			val contact1 = Contact( s1, s2, Vec2D( 5, 5 ), Vec2D( 1, 0 ), 1, t )
			val contact2 = Contact( s2, new Shape {}, Vec2D( 5, 5 ), Vec2D( -1, 0 ), 1, t )
		...
		"throw an exception if contact1.other is not equal to contact2.s." in {
			...
			val s2 = new Shape {}
			val contact1 = Contact( s1, s2, Vec2D( 5, 5 ), Vec2D( 1, 0 ), 1, t )
			val contact2 = Contact( new Shape {}, s1, Vec2D( 5, 5 ), Vec2D( -1, 0 ), 1, t )
		...
		"throw an exception if the points of the contacts don't match." in {
			...
			val s2 = new Shape {}
			val contact1 = Contact( s1, s2, Vec2D( 5, 5 ), Vec2D( 1, 0 ), 1, t )
			val contact2 = Contact( s2, s1, Vec2D( 6, 6 ), Vec2D( -1, 0 ), 1, t )
		...
		"throw an exception if the contact normals don't match." in {
			...
			val s2 = new Shape {}
			val contact1 = Contact( s1, s2, Vec2D( 5, 5 ), Vec2D( 1, 0 ), 1, t )
			val contact2 = Contact( s2, s1, Vec2D( 5, 5 ), Vec2D( 0, -1 ), 1, t )
