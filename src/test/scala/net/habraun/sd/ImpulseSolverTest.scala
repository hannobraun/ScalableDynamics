...
class ImpulseSolverTest {
	...
	def verifyCollisionEffects {
		...
		val collision = Collision(1.0, Contact( b1, b2, Vec2D(0, 0), Vec2D(0, -1), 1.0 ),
				Contact( b2, b1, Vec2D(0, 0), Vec2D(0, 1), 1.0 ))
	...
	def addBodiesThatWouldIntersectAfterMovementVerifyTheyDont {
		...
		val collision = Collision(0.5, Contact( b1, b2, Vec2D(3, 0), Vec2D(1, 0), 1.0 ),
				Contact( b2, b1, Vec2D(3, 0), Vec2D(-1, 0), 1.0 ))
	...
	def testForIntersectionAtHighPositionValues {
		...
		val collision = Collision(0.4766389925763854,
						Contact( b1, b2, Vec2D(3, 0), Vec2D(-0.8732041733361332, -0.4873545646327327), 0.4766389925763854 ),
						Contact( b2, b1, Vec2D(3, 0), Vec2D(0.8732041733361332, 0.4873545646327327), 0.4766389925763854 ))
